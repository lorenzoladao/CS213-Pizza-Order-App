...
/**
 * This class records the actions committed by the user in the Deluxe Pizza view.
 *
 * @author Asif Haque, Margaret Knoebel, Lorenzo Ladao
 */

public class DeluxeActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private static final int MIN_TOPPING_SIZE = 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckBox gpepper = findViewById(R.id.g_pepper);
        gpepper.setChecked(true);
        CheckBox mushroom = findViewById(R.id.mushroom);
        mushroom.setChecked(true);
        CheckBox blolives = findViewById(R.id.bl_olives);
        blolives.setChecked(true);
        pizza = PizzaMaker.createPizza("deluxe");

        priceText = (EditText) findViewById(R.id.priceAmt);
    ...
    public void beefClick(View v){
        ...
        if (beef.isChecked()) {
            ...
            if(pizza.getToppingList().size() == MIN_TOPPING_SIZE) {
                AlertDialog.Builder alert = new AlertDialog.Builder(this);
                alert.setTitle("Warning");
                alert.setMessage("Remove Essential Topping?");
                alert.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
