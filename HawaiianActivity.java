...
/**
 * This class records the actions committed by the user in the Hawaiian Pizza view.
 *
 * @author Asif Haque, Margaret Knoebel, Lorenzo Ladao
 */

public class HawaiianActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private static final int MIN_TOPPING_SIZE = 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pizzaImage.setImageResource(R.drawable.hawaiin);
